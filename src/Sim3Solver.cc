...
void Sim3Solver::ComputeSim3(cv::Mat &P1, cv::Mat &P2)
{
  ...
  cv::Mat Pr1(
    P1.size(), P1.type());  // Relative coordinates to centroid (set 1)
  cv::Mat Pr2(
    P2.size(), P2.type());  // Relative coordinates to centroid (set 2)
