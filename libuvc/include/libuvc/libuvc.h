...
typedef struct uvc_still_frame_desc {
  ...
  /* indication of compression level, the higher, the more compression is
   * applied to image */
...
/* AUTO-GENERATED control accessors! Update them with the output of `ctrl-gen.py
 * decl`. */
